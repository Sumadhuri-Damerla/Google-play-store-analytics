...
## Correlogram plots 
````{r correlogram-plot, out.width="50%", fig.width=3, fig.height=3,fig.show='hold',fig.align='center'}
...
clean_play_store$Price <-
  log(clean_play_store$price) #transforming the price value to logarithmic values
...
```{r correlogram_type,out.width="50%", fig.width=3, fig.height=3,fig.show='hold'}
...
knitr::knit_print(cor.test(clean_play_store$installs, clean_play_store$rating , method = "pearson"))

# Finding Correlation between rating and log10(installs)^2
knitr::knit_print(cor.test(log10(clean_play_store$installs)^2, clean_play_store$rating , method = "pearson"))
```
...
knitr::knit_print(cor.test(clean_play_store$reviews, clean_play_store$rating , method = "pearson"))

# Finding Correlation between rating and log10(reviews)^2
knitr::knit_print(cor.test(log10(clean_play_store$reviews)^2, clean_play_store$rating , method = "pearson"))
...
jitterPlot <- function(x.var){

clean_play_store %>% 
  ggplot(aes_string(x = x.var, y = "rating")) + 
    scale_x_log10() +
  ...
  labs(title = "Jitter Plot",
       subtitle = paste (x.var,"vs Rating", collapse = " "),
       x = x.var,
       y = "Rating",
       caption = "Source: google play store dataset") +
 theme(legend.title = element_text(hjust = 0.5, face="bold", size = 10)) + 
...
This technique helps us identify the best fit model for our dataset i.e. the model with least root mean square error
...
```
 + We sliced the dataset into training and test dataset. Training data det contain 6951 observations (75% of total) and test data set contains 2198 observations (25% of total). 
