...
ggplot(clean_app_store, aes(x = rating,y = category,na.rm = TRUE)) + 
  ...
  ggtitle("App rating vs category") +
...
Average rating of apps in each category does not vary significantly. 
```{r avg_rating_plot, message=FALSE, warning=FALSE}


# Distribution Of Rating For All Categories
...
base + 
  ...
  ggtitle("Distribution of rating of all the categories") +
  labs(y="Count", x = "Rating") +
