...
# Model
In this section we will try to fit models for both explanatory and predictive purpose. We will choose between two different models by using the cress validation technique.  We will choose the model that best fits our data and use it to predict rating for a dummy app.
